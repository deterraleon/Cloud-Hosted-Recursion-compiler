...
- Cloud hosted part isn't implemented, as of now the sql is done locally because i was too lazy to learn how to set up postresql. To use any other sql db go to sqlite_functions.py and provide a get_con() function.
